...
*/
	...
	/* KIV - may need to move to StartOPCUAServer.c
        addMonitoredItemToSoftwareVersionVariable(server);
        addMonitoredItemToDataBlockVersionVariable(server);
        addMonitoredItemToInstrumentTimeVariable(server);
        addMonitoredItemToMeasurementTimeVariable(server);

        addMonitoredItemToBootStatusVariable(server);
        addMonitoredItemToSnapshotStatusVariable(server);
        addMonitoredItemToSCPStatusVariable(server);
        addMonitoredItemToSFTPStatusVariable(server);
        addMonitoredItemToRunScriptStatusVariable(server);
        addMonitoredItemToArchiveStatusVariable(server);
        addMonitoredItemToAncillarySensorStatusVariable(server);

        addMonitoredItemToSensorVariable(server);
        addMonitoredItemToOperatingTimeVariable(server);
        addMonitoredItemToWarningMessageVariable(server);

        addMonitoredItemToIgramPPVariable(server);
        addMonitoredItemToIgramDCVariable(server);
        addMonitoredItemToLaserPPVariable(server);
        addMonitoredItemToLaserDCVariable(server);
        addMonitoredItemToSingleBeamAt900Variable(server);
        addMonitoredItemToSingleBeamAt2500Variable(server);
        addMonitoredItemToSignalToNoiseAt2500Variable(server);
        addMonitoredItemToCenterBurstLocationVariable(server);
        addMonitoredItemToDetectorTempVariable(server);
        addMonitoredItemToLaserFrequencyVariable(server);
        addMonitoredItemToHardDriveSpaceVariable(server);
        addMonitoredItemToFlowVariable(server);
        addMonitoredItemToTemperatureVariable(server);
        addMonitoredItemToPressureVariable(server);
        addMonitoredItemToTempOpticsVariable(server);
        addMonitoredItemToBadScanCounterVariable(server);
        addMonitoredItemToFreeMemorySpaceVariable(server);
        addMonitoredItemToLABFilenameVariable(server);
        addMonitoredItemToLOGFilenameVariable(server);
        addMonitoredItemToLgFilenameVariable(server);
        addMonitoredItemToSecondLgFilenameVariable(server);
        addMonitoredItemToSystemCounterVariable(server);
        addMonitoredItemToDetectorCounterVariable(server);
        addMonitoredItemToLaserCounterVariable(server);
        addMonitoredItemToFlowPumpCounterVariable(server);
        addMonitoredItemToDesiccantCounterVariable(server);
	*/
